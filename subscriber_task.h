...
#define SUBSCRIBE_TASK_STACK_SIZE (1024 * 2)
#define SUBSCRIBE_TASK_PRIORITY (CY_RTOS_PRIORITY_NORMAL)
extern uint64_t subscribe_task_stack[SUBSCRIBE_TASK_STACK_SIZE / 8];
